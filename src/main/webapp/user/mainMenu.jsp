    ...
    <div class="container px-4 px-lg-5 h-100">
        <div class="row gx-4 gx-lg-5 h-100 align-items-center justify-content-center text-center">
            <div class="col-lg-8 align-self-end">
                <h1 class="text-white font-weight-bold">It's Time for Summer Reading on Bbookkk
                </h1>
                <hr class="divider"/>
            </div>
            <div class="col-lg-8 align-self-baseline">
                <p class="text-white-75 mb-5">No matter what else you have planned for this season, we hope picking up a great book or two is on your list! As always, we're happy to lend a hand with recommendations from your fellow readers, bestselling authors, and more!</p>
